...
function HomePage()
{
    ...
    return(
        <div className={`flex-col h-screen w-screen items-center justify-center dark:text-neutral-200 text-neutral-700 cursor-default select-none ${about || settings ? "overflow-y-hidden" : ""}`}>
