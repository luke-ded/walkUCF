...
const Settings: React.FC<ChildProps> = ({triggerRerender, toggleSettings}) =>
{
    ...
    return (
        <div className="absolute z-12 top-1/14 max-lg:top-1/21 left-0 w-full max-w-full h-full max-lg:20/21 flex items-center justify-center bg-black/50">
            <div className="absolute z-12 top-1/8 max-lg:top-1/16 bg-[url(./assets/backgroundmap.jpg)] border-2 dark:border-[#ffca09] border-[#a48100] rounded-md lg:w-3/10 h-7/20 max-lg:h-3/10 max-sm:w-9/10 md:w-5/10 shadow-lg">
                <div className="flex-col justify-center w-full h-full dark:bg-black/80 bg-[#d6d4d4]/80 rounded-sm">
                            ...
                            <div className="relative inline-block">
                                ...
                                {info && (
                                    <div className="flex absolute z-14 w-80 xl:left-5 max-lg:right-1 max-lg:bottom-8 border-2 dark:border-[#ffca09] border-[#a48100] rounded-lg shardow-lg p-1 dark:bg-black bg-white">
                                        <h1 className="dark:text-neutral-200 text-center text-neutral-700 text-sm ml-2">If you wear a smartwatch, check your health app for the most accurate measure of this stat. 
                    ...
                    <div className="flex w-full h-2/8 justify-center items-center">
                        ...
                        <button className="cursor-pointer h-10 mb-5 hover:bg-[#ffe68c]/20 active:bg-[#ffe68c]/20 dark:bg-black/40 bg-white/70 px-2 py-1.5 border-2 dark:border-[#ffe68c] border-[#a48100] rounded-xl"
