...
const Error: React.FC<ChildProps> = ({toggleError}) =>
{
    ...
    return (
        <div className="absolute z-12 top-1/14 left-0 w-full max-w-full h-13/14 flex items-center justify-center bg-black/50">
            <div className="absolute z-12 bg-[url(./assets/backgroundmap.jpg)] border-2 dark:border-red-400 border-red-500 rounded-md lg:w-2/10 h-3/10 max-sm:w-9/10 md:w-5/10 shadow-lg">
                <div className="flex-col justify-center w-full h-full dark:bg-black/80 bg-[#d6d4d4]/80 rounded-sm">
                    <div className="flex-col justify-center items-center max-sm:text-sm text-md dark:text-neutral-200 text-neutral-700 text-center h-6/8 p-3">
                        ...
                        <p className="mt-3">If this is probably incorrect, please submit a bug report <a href="https://forms.gle/XmwzZMkAw9f15xzs6" target="_blank" rel="noopener noreferrer" className="inline font-bold dark:text-red-400 text-red-500 dark:hover:text-red-300 hover:text-red-700">here</a> with the names & entrances of these two locations.</p>
                    </div>
