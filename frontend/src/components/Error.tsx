...
const Error: React.FC<ChildProps> = ({toggleError}) =>
{
    ...
    return (
        <div className="absolute z-12 top-1/14 max-lg:top-1/21 left-0 w-full max-w-full h-full max-lg:20/21 flex items-center justify-center bg-black/50">
            <div className="absolute z-12 top-1/8 max-lg:top-1/16 bg-[url(./assets/backgroundmap.jpg)] border-2 dark:border-red-400 border-red-500 rounded-md lg:w-3/10 h-9/20 max-md:h-3/10 max-sm:w-9/10 md:w-5/10 shadow-lg">
