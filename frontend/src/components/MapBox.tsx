...
const MapBox: React.FC<ChildProps> = ({ stops, triggerRerender, toggleError }) => {
  ...
  const [tileSelection, setTileSelection] = useState<string>(localStorage.getItem("tile") ?? "OSM Default");
  ...
  return (
    <div className="h-full w-full">
            ...
            className="absolute z-10 mt-20 ml-[50px] flex h-[220px] w-[140px] cursor-pointer items-center justify-center rounded-[4px] bg-black/20 text-[18px] font-bold text-black">
              <div className="flex flex-col h-[216px] w-[136px] items-center justify-between rounded-[2px] bg-[#ffffff] p-1 text-sm">
                {[...tileSelectionOptions.entries()].map(([key]) => (
                  ...
                  onClick={() => {handleTileSelection(key); setTileModal(false); setLoading(true)}}>
      ...
      <div className="text-md flex h-3/40 w-full items-center justify-center rounded-b-sm bg-white/50 font-bold max-xl:text-xs max-sm:h-5/40 dark:bg-black/50">
        <button
          className={`ml-[3%] flex inline-block h-8/10 w-fit items-center rounded-sm border-2 border-[#a48100] px-1 text-center dark:border-[#ffca09] ${!buildings ? "bg-[#a48100] hover:bg-[#a48100]/80 text-neutral-200 dark:bg-[#ffca09] dark:text-neutral-700 dark:hover:bg-[#ffca09]/80" : "bg-[#ffca09]/50 text-neutral-600 dark:text-neutral-50 hover:bg-[#ffca09]/60"} cursor-pointer text-center font-bold`}
          onClick={() => setBuilding(!buildings)}
        >
          Buildings
        </button>
        <button
          className={`ml-[3%] flex inline-block h-8/10 w-fit items-center rounded-sm border-2 border-[#a48100] px-1 text-center dark:border-[#ffca09] ${!jaywalking ? "bg-[#a48100] hover:bg-[#a48100]/80 text-neutral-200 dark:bg-[#ffca09] dark:text-neutral-700 dark:hover:bg-[#ffca09]/80" : "bg-[#ffca09]/50 text-neutral-600 dark:text-neutral-50 hover:bg-[#ffca09]/60"} cursor-pointer text-center font-bold`}
          onClick={() => setJaywalking(!jaywalking)}
        >
          Jaywalking
        </button>
        <button
          className={`ml-[3%] flex inline-block h-8/10 w-fit items-center rounded-sm border-2 border-[#a48100] px-1 text-center dark:border-[#ffca09] ${!parking ? "bg-[#a48100] hover:bg-[#a48100]/80 text-neutral-200 dark:bg-[#ffca09] dark:text-neutral-700 dark:hover:bg-[#ffca09]/80" : "bg-[#ffca09]/50 text-neutral-600 dark:text-neutral-50 hover:bg-[#ffca09]/60"} cursor-pointer text-center font-bold`}
          onClick={() => setParking(!parking)}
        >
          Parking Lots
        </button>
        <button
          className={`mr-[3%] ml-[3%] flex inline-block h-8/10 w-fit items-center rounded-sm border-2 border-[#a48100] px-1 text-center dark:border-[#ffca09] ${!grass ? "bg-[#a48100] hover:bg-[#a48100]/80 text-neutral-200 dark:bg-[#ffca09] dark:text-neutral-700 dark:hover:bg-[#ffca09]/80" : "bg-[#ffca09]/50 text-neutral-600 dark:text-neutral-50 hover:bg-[#ffca09]/60"} cursor-pointer text-center font-bold`}
